...
export default function Footer({ data }: { data: FooterData }) {
  ...
  return (
    <motion.footer
      ...
      className="w-full backdrop-blur-md px-4 md:px-8 lg:px-12 py-4 md:py-0 md:h-20 flex flex-col md:flex-row items-center justify-between text-[10px] md:text-sm gap-2 md:gap-0 border-t transition-colors"
      style={{
